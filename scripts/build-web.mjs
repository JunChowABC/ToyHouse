...
const homeCode = (await readFile(new URL("../src/home-screen.js", import.meta.url), "utf8"))
  ...
  .replace(/^export /gm, "");
const bundled = source.replace('import LEVEL_CONFIG from "./level-config.js";', config.replace("export default", "const LEVEL_CONFIG ="))
...
await writeFile(new URL("../docs/index.html", import.meta.url), html.replace('src="src/game.js"', 'src="game.js"'));
